...
$(function() {
    $('.chart01').easyPieChart({
        barColor: "#e96656",//#ef1e25",
                trackColor: "#1b1b1b",//"#f9f9f9",
                scaleColor: "#ffddcc",//#dfe0e0",
                 lineCap: "square",
                lineWidth: 18,
                size: 210,
                rotate: 0,
	    ...
	    $('.chart04').easyPieChart({
        barColor: "#e7ac44",//#ef1e25",
                trackColor: "#1b1b1b",//"#f9f9f9",
                scaleColor: "#ffddcc",//#dfe0e0",
                lineCap: "square",
                lineWidth:18,
...
! function(a, b) {
    ...
    var b = function(a, b) {
        ...
        c = function(a, c) {
            var d = {
                //easing: 'easeOutBounce',
                barColor: "#cc0000",//#ef1e25",
                trackColor: "#fcfcfc",//"#f9f9f9",
                scaleColor: "#ffddcc",//#dfe0e0",
                lineCap: "round",
                lineWidth: 8,
                size: 110,
